package alljobscircularbd.bd.com.alljobscircularbd;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            window.setStatusBarColor(Color.parseColor("#5A974A"));
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.update) {
            ...
            if (isNetworkConnected()) {
                ...
                devAccount.setData(Uri.parse("market://details?id=alljobscircularbd.bd.com.alljobscircularbd"));
